...
export default function WishListPage() {
  ...
  const imageUrl =
    "https://img1.kakaocdn.net/thumb/C414x414@2x.fwebp.q82/?fname=https%3A%2F%2Fst.kakaocdn.net%2Fproduct%2Fgift%2Fproduct%2F20240119113721_c2ec0eeb5cfe4f4fb72a7b4b4b99f538.jpg";
  const brandImageUrl =
  ...
  const title =
    "[단독]하겐다즈 프리미엄 수제 아이스크림 케이크 리얼블랑 (바닐라+벨지안초코)";
  const price = "32,900";
